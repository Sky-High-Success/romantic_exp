...
180),ulp_onidle_displayed=!0;ulp_write_cookie("ulp-inline-"+ulp_active_window_id,ulp_cookie_value,180);ulp_track(ulp_active_window_id,"layered-popup","subscribe",jQuery("#ulp-"+ulp_active_window_id).find('[name="ulp-email"]').val());_ulp_open(ulp_active_window_id,!1,!1);a=0;c.close_delay&&(a=c.close_delay);var k=c.return_url;setTimeout(function(){0<k.length?location.href=k:(ulp_self_close(),ulp_subscribing=!1)},a)}else"ERROR"==f?(ulp_subscribing=!1,jQuery("#ulp-"+ulp_active_window_id).find(".ulp-input-field").each(function(){var a=
jQuery(this).attr("name");"ERROR"==c[a]&&jQuery(this).addClass("ulp-input-error")})):(ulp_subscribing=!1,jQuery("#ulp-"+ulp_active_window_id).find(".ulp-submit").html(b+"Error!"))}catch(n){ulp_subscribing=!1,jQuery("#ulp-"+ulp_active_window_id).find(".ulp-submit").html(b+"Error!")}});return!1}
